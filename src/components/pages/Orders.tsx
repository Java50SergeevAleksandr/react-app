...
export const Orders: React.FC = () => {
    ...
    const columns: GridColDef[] = [
        {
            field: 'id', headerName: 'Order ID', flex: 0.5, align: 'center', headerAlign: 'center'
        },
    ...
    function getColumns(): GridColDef<OrderType, any, any>[] {
        return authUser.includes('admin') ? [...columns, ...adminColumns] : columns
    }
    ...
    return <Box>
        <Box sx={{ width: "80vw", height: "60vh" }}>
            <DataGrid columns={getColumns()} rows={orders} getRowHeight={() => 'auto'}
